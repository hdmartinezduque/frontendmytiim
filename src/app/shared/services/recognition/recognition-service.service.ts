...
import { GetRecognition, PostRecognition, RecognitionTeam, RecognitionUser } from '../../interfaces/recognition/recognition';
...
export class RecognitionServiceService {
  ...
  public viewAllRecognition(): Observable<Array<GetRecognition>> { 
    return this.http.get({ endpoint: 'comment/recognition/list' })
}
