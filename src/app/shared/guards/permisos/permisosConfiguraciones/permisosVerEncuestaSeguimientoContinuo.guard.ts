...
export class PermisosVerEncuestaSeguimientoContinuo implements CanActivate {
    constructor(
    ...
    canActivate(route: ActivatedRouteSnapshot, state: RouterStateSnapshot): boolean {
        ...
        const permisosRoles: any =  permisos.modulos?.configuraciones.encuestaSeguimientoContinuo.roles;
